...
NutriLink/ ├── public/ # Static assets ├── src/ │ ├── components/ # Reusable UI components │ ├── pages/ # Main pages (Home, About, Contact, etc.) │ ├── contexts/ # (Optional) Global state management │ ├── data/ # Static or configuration data │ ├── App.jsx # Main App component with routing │ ├── main.jsx # Application entry point │ └── index.css # Tailwind + global styles
...
👩‍💻 Author Developed by: Muskan Pandey
